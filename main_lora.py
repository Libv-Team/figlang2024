...
model = LlavaForConditionalGeneration.from_pretrained(model_base, low_cpu_mem_usage=True, torch_dtype=torch.float16).to(
    0)
...
model2 = PeftModel.from_pretrained(model, model_path)
print('Merging LoRA weights...')
model2 = model2.merge_and_unload()
print('Model is loaded...')
model.to(0)

# model = LlavaForConditionalGeneration.from_pretrained(model_base, torch_dtype=torch.float16,
